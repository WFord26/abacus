...
- Local setup automation: added root `env:check`, `bootstrap:local`, `migrate:all`, and `seed:local` commands with shared `.env` validation and repeatable Docker-plus-migrations bootstrap flow.
